---
title: "Soda"
meta_title: "What is Soda? | Data Lakehouse & AI Glossary"
description: "An open-source data quality and observability platform that allows teams to detect data issues early in the pipeline."
---

## What is Soda?

An open-source data quality and observability platform that allows teams to detect data issues early in the pipeline. This capability serves as a critical enabler in modern data ecosystems, explicitly guiding architecture toward absolute efficiency and scale. When correctly implemented, Soda dynamically drives analytical workloads and structurally limits administrative technical debt.
