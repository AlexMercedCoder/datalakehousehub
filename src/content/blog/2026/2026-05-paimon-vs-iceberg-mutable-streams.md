...
date: 2026-05-24T11:15:00Z
pubDatetime: 2026-05-24T11:15:00Z
...
![Architecture diagram comparing Paimon LSM-tree with in-memory buffer, SSTable file levels, and background compaction against Iceberg merge-on-read with separate data files and delete files requiring query-time merge](/images/blog/paimon-vs-iceberg-mutable-streams/paimon-lsm-vs-iceberg-mor-architecture.png)
...
![Two-by-two decision matrix showing Paimon as best choice for high-frequency CDC workloads with narrow Flink-focused ecosystem, and Iceberg as best for broad multi-engine access regardless of update frequency](/images/blog/paimon-vs-iceberg-mutable-streams/paimon-vs-iceberg-workload-decision-matrix.png)
