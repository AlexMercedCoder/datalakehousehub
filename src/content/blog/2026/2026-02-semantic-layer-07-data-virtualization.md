...
![ETL pipelines vs. data virtualization — physical movement vs. lightweight connections](/images/blog/semantic-layer/etl-vs-virtual.png)
...
![Virtualize vs. materialize decision framework](/images/blog/semantic-layer/virtualize-materialize.png)
