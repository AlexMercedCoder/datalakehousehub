...
This is Part 3 of a 10-part series on query engine design. [Part 2](/blog/2026-04-29-query-engine-optimization-02-row-vs-column-storage) covered row vs. column storage layouts. This article goes one level deeper: how data is physically structured within files, and what metadata accompanies it to make reads efficient.
...
![The write speed vs read efficiency spectrum showing heap files, LSM trees, B-trees, and sorted files](/images/blog/query-engine-optimization/03-data-organization-on-disk-write-read-spectrum.png)
...
![Anatomy of a Parquet file showing row groups, column chunks, pages, and the footer with schema and statistics](/images/blog/query-engine-optimization/03-data-organization-on-disk-parquet-file-anatomy.png)
...
![How min/max statistics allow the engine to skip irrelevant row groups when filtering by price](/images/blog/query-engine-optimization/03-data-organization-on-disk-predicate-pushdown-min-max.png)
