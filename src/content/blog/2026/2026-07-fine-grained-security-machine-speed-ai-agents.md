...
![Papercut agent identity flowing through MCP, policy, query engine, catalog, and lakehouse data](/images/blog/week-jul06/fine-grained-security-machine-speed-ai-agents-diagram-1.png)
...
![Papercut fine-grained policy checks for row, column, metric, and tool access](/images/blog/week-jul06/fine-grained-security-machine-speed-ai-agents-diagram-2.png)
...
![Papercut audited AI agent loop inside governed lakehouse architecture](/images/blog/week-jul06/fine-grained-security-machine-speed-ai-agents-diagram-3.png)
