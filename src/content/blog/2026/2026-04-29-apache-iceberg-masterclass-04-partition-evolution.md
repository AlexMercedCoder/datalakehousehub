...
This is Part 4 of a 15-part [Apache Iceberg Masterclass](/blog/2026-04-29-apache-iceberg-masterclass-01-table-formats). [Part 3](/blog/2026-04-29-apache-iceberg-masterclass-03-iceberg-metadata-performance) covered metadata-driven performance. This article explains how Iceberg handles the problem that has plagued data lakes for over a decade: what happens when your partition strategy needs to change.
...
![Hive-style directory-based partitioning with its three core problems](/images/blog/apache-iceberg-masterclass/04-partition-evolution-hive-partition-directories.png)
...
![Iceberg partition evolution showing how old and new partition specs coexist without rewriting data](/images/blog/apache-iceberg-masterclass/04-partition-evolution-iceberg-partition-evolution.png)

Iceberg separates the logical partition specification from the physical data layout through two mechanisms: hidden partitioning (covered in [Part 5](/blog/2026-04-29-apache-iceberg-masterclass-05-hidden-partitioning)) and partition evolution.
...
![How engines resolve queries across multiple partition specs by evaluating each independently](/images/blog/apache-iceberg-masterclass/04-partition-evolution-multi-spec-query-planning.png)
...
Partition evolution is one of the features that makes Iceberg a safe long-term choice. It means the partitioning decision you make today is not permanent. [Part 5](/blog/2026-04-29-apache-iceberg-masterclass-05-hidden-partitioning) covers hidden partitioning, the other half of Iceberg's partitioning story.
