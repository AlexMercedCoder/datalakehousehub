...
![Papercut MCP host, client, stateless server pool, and lakehouse resources architecture](/images/blog/week-jul06/mcp-2026-07-28-stateless-spec-data-platforms-diagram-1.png)
...
![Papercut tool call lifecycle with identity, consent, policy, query, result, and audit](/images/blog/week-jul06/mcp-2026-07-28-stateless-spec-data-platforms-diagram-2.png)
...
![Papercut Agentic Lakehouse stack with MCP interface layer above governed tools, semantic layer, query, catalog, Iceberg tables, and storage](/images/blog/week-jul06/mcp-2026-07-28-stateless-spec-data-platforms-diagram-3.png)
