...
---
> **Cross-posted.** This article's canonical home is [Iceberg Lakehouse](https://iceberglakehouse.com/posts/2026-02-debp-observability-monitoring/).
...
![Three pillars: metrics tracking counts and timing, logs recording execution details, lineage mapping data flow](/images/blog/debp/three-pillars.png)
...
![Alert severity levels: critical triggers pages, warning goes to channel, info logged](/images/blog/debp/alert-levels.png)
