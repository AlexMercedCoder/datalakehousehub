...
![Papercut architecture showing REST catalog control plane and Arrow Flight data plane](/images/blog/wk-jul06/arrow-flight-iceberg-rest-catalog-columnar-transfers-./diagram-1.png)
...
![Papercut query lifecycle showing catalog lookup, authorization, planning, columnar transfer, and result use](/images/blog/wk-jul06/arrow-flight-iceberg-rest-catalog-columnar-transfers-./diagram-2.png)
...
![Papercut stack showing storage, Iceberg, REST catalog, query engine, Arrow Flight, semantic layer, and clients](/images/blog/wk-jul06/arrow-flight-iceberg-rest-catalog-columnar-transfers-./diagram-3.png)
