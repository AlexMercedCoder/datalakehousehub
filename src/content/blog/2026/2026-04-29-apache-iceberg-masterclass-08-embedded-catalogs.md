...
This is Part 8 of a 15-part [Apache Iceberg Masterclass](/blog/2026-04-29-apache-iceberg-masterclass-01-table-formats). [Part 7](/blog/2026-04-29-apache-iceberg-masterclass-07-lakehouse-catalogs) covered the traditional catalog landscape. This article examines a newer approach: embedding the catalog directly inside the storage layer.
...
![Standalone catalogs versus embedded catalogs showing how the architecture simplifies](/images/blog/apache-iceberg-masterclass/08-embedded-catalogs-embedded-vs-standalone.png)
...
![S3 Tables architecture showing the built-in Iceberg catalog with automatic compaction](/images/blog/apache-iceberg-masterclass/08-embedded-catalogs-s3-tables-architecture.png)
...
**Built-in maintenance:** S3 Tables runs automatic compaction in the background, merging small files into optimally-sized ones without any user configuration. It also handles snapshot expiry and orphan file cleanup. This eliminates one of the biggest operational burdens of Iceberg (covered in [Part 10](/blog/2026-04-29-apache-iceberg-masterclass-10-maintaining-iceberg)).
...
[Part 9](/blog/2026-04-29-apache-iceberg-masterclass-09-storage-degradation) covers how table storage degrades over time and why maintenance matters regardless of which catalog you use.
