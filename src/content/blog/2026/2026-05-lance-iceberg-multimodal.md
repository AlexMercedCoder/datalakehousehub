...
![Lance and Iceberg multimodal AI lakehouse architecture showing object store for raw blobs, Iceberg tables for structured metadata with SQL analytics, and LanceDB for embeddings with vector search, all fed by a multimodal ingestion pipeline using CLIP, Whisper, and custom encoders](/images/blog/lance-iceberg-multimodal/lance-iceberg-multimodal-architecture.png)
...
![Lance vs Iceberg workload fit matrix comparing analytical SQL queries, training data retrieval, embedding/vector search, and structured+unstructured joins across both formats](/images/blog/lance-iceberg-multimodal/lance-vs-iceberg-workload-fit-matrix.png)
