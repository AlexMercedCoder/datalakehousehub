...
![Two-Phase Locking versus MVCC showing how locking blocks readers while MVCC allows concurrent access](/images/blog/query-engine-optimization/10-concurrency-control-locking-vs-mvcc.png)
...
![MVCC version chain showing three versions of the same row with different transactions seeing different versions](/images/blog/query-engine-optimization/10-concurrency-control-mvcc-version-chain.png)
...
![Isolation level spectrum from Read Uncommitted (weakest, fastest) to Serializable (strongest, slowest)](/images/blog/query-engine-optimization/10-concurrency-control-isolation-levels.png)
