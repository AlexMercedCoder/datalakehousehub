...
![Papercut architecture showing a central open catalog hub connected to multicloud lakehouse zones and engines](/images/blog/wk-jul06/multi-engine-catalog-federation-apache-polaris-multicloud-./diagram-1.png)
...
![Papercut diagram showing identity and role mapping across policy gateway and cloud zones](/images/blog/wk-jul06/multi-engine-catalog-federation-apache-polaris-multicloud-./diagram-2.png)
...
![Papercut open lakehouse governance model with shared catalog, query federation, semantic layer, and clients](/images/blog/wk-jul06/multi-engine-catalog-federation-apache-polaris-multicloud-./diagram-3.png)
