...
slug: 2026-05-modern-feature-stores
draft: false
...
![Feast streaming feature view architecture showing Kafka and Kinesis event sources feeding Feast Feature Server with streaming feature views and point-in-time correct joins, routing to Redis online store for <10ms real-time serving and Parquet/Iceberg offline store for model training](/images/blog/modern-feature-stores/feast-streaming-feature-view-architecture.png)
...
![Feature store offline and online architecture with batch features from S3/Iceberg via Spark and real-time features from Kafka via Flink, connected through Feast feature registry for training-serving consistency](/images/blog/modern-feature-stores/feature-store-offline-online-architecture.png)
