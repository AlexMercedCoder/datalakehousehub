...
![Merge pattern: staging records matched against target by business key, updating or inserting](/images/blog/debp/merge-pattern.png)
...
![Anti-patterns: blind append creating duplicates, timestamp-based keys, deferred dedup](/images/blog/debp/idempotency-antipatterns.png)
