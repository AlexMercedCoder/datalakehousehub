...
description: "If you drop ten thousand Parquet files into an S3 bucket, you have a data swamp. You do not have a database. To run SQL queries against those files..."
author: "Alex Merced"
...
![The Iceberg Metadata Tree showing the path from Catalog down to Data Files](/images/blog/apache-lakehouse-iceberg-metadata-tree.png)
...
![Diagram showing Schema Evolution mapping unique column IDs to file structures over time](/images/blog/apache-lakehouse-iceberg-schema-evolution.png)
...
![Diagram showing Time Travel snapshots pointing an overlapping set of underlying Parquet files](/images/blog/apache-lakehouse-iceberg-time-travel.png)
