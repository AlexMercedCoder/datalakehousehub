...
![Cache hit versus cache miss latency showing the 1000x gap between RAM and SSD access](/images/blog/query-engine-optimization/07-memory-and-caching-cache-hit-miss-latency.png)
...
![Buffer pool architecture showing shared memory pages, page table, cache hits, and background writes to disk](/images/blog/query-engine-optimization/07-memory-and-caching-buffer-pool-architecture.png)
...
![How engines divide available memory between data cache, sort buffers, hash tables, and network buffers](/images/blog/query-engine-optimization/07-memory-and-caching-memory-budget-allocation.png)
