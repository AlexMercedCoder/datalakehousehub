...
![Five key components of a semantic layer connected to a central hub](/images/blog/semantic-layer/sl-components.png)
...
![Without vs. with a semantic layer — from metric chaos to alignment](/images/blog/semantic-layer/without-vs-with.png)
