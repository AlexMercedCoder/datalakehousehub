...
This is Part 2 of a 15-part [Apache Iceberg Masterclass](/blog/2026-04-29-apache-iceberg-masterclass-01-table-formats). [Part 1](/blog/2026-04-29-apache-iceberg-masterclass-01-table-formats) covered why table formats exist. This article breaks down exactly how each format organizes its metadata.
...
![Iceberg's three-layer metadata architecture from catalog to metadata.json to manifest list to manifest files to data files](/images/blog/apache-iceberg-masterclass/02-metadata-structures-iceberg-metadata-tree.png)
...
![Delta Lake's transaction log structure with JSON commits, Parquet checkpoints, and the reader process](/images/blog/apache-iceberg-masterclass/02-metadata-structures-delta-lake-transaction-log.png)
...
[Part 3](/blog/2026-04-29-apache-iceberg-masterclass-03-iceberg-metadata-performance) covers how query engines use Iceberg's metadata specifically for performance optimization.
