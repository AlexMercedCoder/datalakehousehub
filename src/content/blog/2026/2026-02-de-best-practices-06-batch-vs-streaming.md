...
![Spectrum from batch to streaming with example use cases at each latency level](/images/blog/debp/latency-spectrum.png)
...
![Decision framework: start batch, upgrade to micro-batch, stream only when sub-second needed](/images/blog/debp/decision-framework.png)
