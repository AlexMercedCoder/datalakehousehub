...
description: "If you ask a data analyst to calculate the average transaction amount for the month of July using a massive CSV file, the compute engine must read ..."
author: "Alex Merced"
...
![Diagram of Dictionary Encoding mapping text strings to small integer identifiers](/images/blog/apache-lakehouse-parquet-dictionary-encoding.png)
...
![Diagram of Predicate Pushdown showing the engine skipping a row group based on min/max stats](/images/blog/apache-lakehouse-parquet-predicate-pushdown.png)
