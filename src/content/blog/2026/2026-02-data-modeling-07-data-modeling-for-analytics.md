...
![Chain of joins through normalized tables versus one wide scan through a denormalized table](/images/blog/data-modeling/normalized-vs-denormalized-query.png)
...
![Analytics model with wide tables, pre-aggregations, and columnar storage feeding dashboards](/images/blog/data-modeling/analytics-architecture.png)
