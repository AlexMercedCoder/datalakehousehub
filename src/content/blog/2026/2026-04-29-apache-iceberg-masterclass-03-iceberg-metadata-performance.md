...
This is Part 3 of a 15-part [Apache Iceberg Masterclass](/blog/2026-04-29-apache-iceberg-masterclass-01-table-formats). [Part 2](/blog/2026-04-29-apache-iceberg-masterclass-02-metadata-structures) covered the metadata structures of all five table formats. This article focuses on exactly how query engines use Iceberg's metadata to avoid reading data they don't need.
...
![Iceberg scan planning cascade showing how metadata progressively eliminates files at each stage](/images/blog/apache-iceberg-masterclass/03-iceberg-metadata-performance-scan-planning-cascade.png)
...
![Three layers of data skipping showing partition pruning, file pruning, and the final result](/images/blog/apache-iceberg-masterclass/03-iceberg-metadata-performance-pruning-example.png)
...
![Per-file statistics tracked in Iceberg manifest entries](/images/blog/apache-iceberg-masterclass/03-iceberg-metadata-performance-per-file-statistics.png)
...
2. **Consider partition evolution** (covered in [Part 4](/blog/2026-04-29-apache-iceberg-masterclass-04-partition-evolution)) to add a partition transform on the column.
