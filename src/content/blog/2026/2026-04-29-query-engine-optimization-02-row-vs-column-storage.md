...
![How the same 5 records look in row-oriented layout versus column-oriented layout on disk](/images/blog/query-engine-optimization/02-row-vs-column-storage-row-vs-column-layout.png)
