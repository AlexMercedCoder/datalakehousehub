...
This is Part 4 of a 10-part series on query engine design. [Part 3](/blog/2026-04-29-query-engine-optimization-03-data-organization-on-disk) covered how data is structured within files. This article covers the auxiliary data structures that make lookups fast: indexes.
...
![B-tree structure showing root, internal, and leaf nodes with point lookup and range scan paths](/images/blog/query-engine-optimization/04-indexing-strategies-btree-structure.png)
...
![LSM tree write path from memtable through WAL flush to SSTables across multiple levels with compaction](/images/blog/query-engine-optimization/04-indexing-strategies-lsm-tree-write-path.png)
