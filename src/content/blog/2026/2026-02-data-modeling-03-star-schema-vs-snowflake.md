...
![Snowflake schema with fact table and normalized, branching dimension tables](/images/blog/data-modeling/snowflake-schema-detail.png)
...
![Star schema query execution flowing through a query engine with automatic optimization](/images/blog/data-modeling/star-schema-optimization.png)
