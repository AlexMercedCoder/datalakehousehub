...
![Sorted data within partitions enabling file-level skip based on min/max metadata](/images/blog/debp/sorted-files.png)
...
![Common mistakes: too many partitions, wrong partition key, no compaction](/images/blog/debp/partition-mistakes.png)
