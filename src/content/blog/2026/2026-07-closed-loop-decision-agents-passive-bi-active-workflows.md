...
![Papercut closed-loop analytics workflow from observe to reason to validate to act to learn](/images/blog/week-jul06/closed-loop-decision-agents-passive-bi-active-workflows-diagram-1.png)
...
![Papercut guardrails around AI agent tool calls including policy, approval, validation, rollback, and audit](/images/blog/week-jul06/closed-loop-decision-agents-passive-bi-active-workflows-diagram-2.png)
...
![Papercut lakehouse-centered agent control plane with monitoring, semantic definitions, validation, approval workflow, and action endpoint](/images/blog/week-jul06/closed-loop-decision-agents-passive-bi-active-workflows-diagram-3.png)
