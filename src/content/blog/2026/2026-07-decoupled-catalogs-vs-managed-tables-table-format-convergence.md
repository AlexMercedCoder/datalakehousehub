...
![Papercut comparison of a bundled managed table stack and a decoupled open catalog stack](/images/blog/week-2026-07-06/decoupled-catalogs-vs-managed-tables-table-format-convergence-diagram-1.png)
...
![Papercut decision matrix with icons for convenience, control, portability, governance, cost, and engine choice](/images/blog/week-2026-07-06/decoupled-catalogs-vs-managed-tables-table-format-convergence-diagram-2.png)
...
![Papercut open architecture with multiple engines over one governed lakehouse and semantic query layer](/images/blog/week-2026-07-06/decoupled-catalogs-vs-managed-tables-table-format-convergence-diagram-3.png)
