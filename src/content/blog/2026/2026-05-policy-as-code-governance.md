...
pubDatetime: 2026-05-24T11:20:00Z
...
![Three-level policy hierarchy showing organization-level OPA tag-based policies at top flowing down to data domain policies and then to table-level row filters and column masks](/images/blog/policy-as-code-governance/policy-hierarchy-lakehouse.png)
...
![Policy-as-code tag-driven access control flow showing user query request flowing through policy engine consulting column tags and row filter policies, evaluating to allow (full result) or deny/mask, with audit log](/images/blog/policy-as-code-governance/policy-as-code-tag-driven-access-flow.png)
