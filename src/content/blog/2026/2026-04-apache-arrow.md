...
description: "If you pull a million records from a database into a Python notebook, the query runs instantly, but the transfer feels endlessly slow. Your compute..."
author: "Alex Merced"
...
![Diagram showing the serialization tax burning CPU cycles while translating data between languages](/images/blog/apache-lakehouse-serialization-tax.png)
...
![Zero-Copy architecture showing two different languages pointing to the exact same memory buffer](/images/blog/apache-lakehouse-zero-copy-arrow.png)
...
![Arrow Flight RPC versus traditional REST/ODBC protocols over a network](/images/blog/apache-lakehouse-arrow-flight-rpc.png)
