...
![Schema test examples: column existence, type validation, null checks, uniqueness checks](/images/blog/debp/schema-tests.png)
...
![Regression testing: comparing aggregates, distributions, and trends over time](/images/blog/debp/regression-testing.png)
