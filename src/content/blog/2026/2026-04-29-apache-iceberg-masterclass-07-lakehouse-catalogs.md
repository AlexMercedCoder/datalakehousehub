...
This is Part 7 of a 15-part [Apache Iceberg Masterclass](/blog/2026-04-29-apache-iceberg-masterclass-01-table-formats). [Part 6](/blog/2026-04-29-apache-iceberg-masterclass-06-writing-to-iceberg) covered the write process and explained how the catalog enables atomic commits. This article covers what catalogs are, why they matter, and how to choose between the many options available in 2026.
...
![The three core responsibilities of a lakehouse catalog](/images/blog/apache-iceberg-masterclass/07-lakehouse-catalogs-catalog-role.png)

Every Iceberg catalog performs three functions:

**Store the current metadata pointer.** When a query engine asks for table `analytics.orders`, the catalog returns the location of the current `metadata.json` file (e.g., `s3://warehouse/orders/metadata/v42.metadata.json`). This is the most fundamental responsibility. As described in [Part 6](/blog/2026-04-29-apache-iceberg-masterclass-06-writing-to-iceberg), the atomic update of this pointer is what makes ACID transactions possible.
...
![How the Iceberg REST Catalog Protocol works from table load through atomic commit](/images/blog/apache-iceberg-masterclass/07-lakehouse-catalogs-rest-catalog-protocol.png)
...
![Open source vs managed catalog options in the 2026 lakehouse ecosystem](/images/blog/apache-iceberg-masterclass/07-lakehouse-catalogs-catalog-landscape.png)
...
[Part 8](/blog/2026-04-29-apache-iceberg-masterclass-08-embedded-catalogs) covers a newer approach where the catalog is embedded directly in the storage layer.
