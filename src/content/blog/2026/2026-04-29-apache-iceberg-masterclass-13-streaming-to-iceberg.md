...
![Three approaches to streaming data into Iceberg: Spark, Flink, and Kafka Connect](/images/blog/apache-iceberg-masterclass/13-streaming-to-iceberg-streaming-approaches.png)
...
**Partitioned writes:** Flink can route events to partitions dynamically based on partition transforms. Combined with Iceberg's [hidden partitioning](/blog/2026-04-29-apache-iceberg-masterclass-05-hidden-partitioning), this means streaming data lands in the correct partition directory automatically without any special logic in the streaming application.
...
![Why streaming creates small files and how compaction fixes them in a continuous cycle](/images/blog/apache-iceberg-masterclass/13-streaming-to-iceberg-streaming-compaction-cycle.png)

Every streaming approach shares the same fundamental problem: frequent commits produce small files. The solution is to pair streaming ingestion with aggressive [compaction](/blog/2026-04-29-apache-iceberg-masterclass-10-maintaining-iceberg).
...
[Dremio's automatic table optimization](https://www.dremio.com/blog/table-optimization-in-dremio/) handles this compaction automatically for tables managed by Open Catalog. AWS [S3 Tables](/blog/2026-04-29-apache-iceberg-masterclass-08-embedded-catalogs) also provides built-in compaction for streaming workloads.
...
4. **Monitoring** ([metadata tables](/blog/2026-04-29-apache-iceberg-masterclass-11-metadata-tables)): Tracks file counts, sizes, and commit frequency
...
After deploying a streaming pipeline, monitor these metrics daily using [metadata tables](/blog/2026-04-29-apache-iceberg-masterclass-11-metadata-tables):
...
[Part 14](/blog/2026-04-29-apache-iceberg-masterclass-14-hands-on-dremio-cloud) provides a hands-on walkthrough of Iceberg on Dremio Cloud.
