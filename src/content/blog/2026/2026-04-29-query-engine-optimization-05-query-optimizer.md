...
![How optimizers transform SQL through logical and physical plan stages into an execution plan](/images/blog/query-engine-optimization/05-query-optimizer-sql-to-execution-plan.png)
...
![Join reordering showing how the same three-table query can be 10x faster or slower depending on which tables are joined first](/images/blog/query-engine-optimization/05-query-optimizer-join-reordering.png)
...
![Adaptive query execution changing a shuffle join to a broadcast join mid-flight based on actual data sizes](/images/blog/query-engine-optimization/05-query-optimizer-adaptive-query-execution.png)
