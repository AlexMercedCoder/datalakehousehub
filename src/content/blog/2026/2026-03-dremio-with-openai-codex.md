...
description: "How to connect Dremio with OpenAI Codex CLI : query lakehouse data, build apps, and use MCP for AI-powered analytics."
author: "Alex Merced"
category: "Dremio"
...
![OpenAI Codex CLI connecting to Dremio Agentic Lakehouse via MCP](/images/blog/ai-tools/codex-dremio-mcp-architecture.png)
