...
This is Part 8 of a 10-part series on query engine design. [Part 7](/blog/2026-04-29-query-engine-optimization-07-memory-and-caching) covered memory management. This article covers how engines divide data across files, disks, or cluster nodes to enable parallel processing and reduce the amount of data each query must touch.
...
![Hash, range, and list partitioning strategies showing how the same data is distributed differently](/images/blog/query-engine-optimization/08-partitioning-partition-types.png)
...
![Partition pruning showing 5 of 6 monthly partitions skipped when filtering by March](/images/blog/query-engine-optimization/08-partitioning-partition-pruning.png)
...
![The data skew problem showing one partition with 10x more data creating a straggler node](/images/blog/query-engine-optimization/08-partitioning-data-skew-problem.png)
