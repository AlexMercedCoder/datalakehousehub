...
matrix = {
    ...
    "Lakehouse & Storage": {
        "keywords": ["lakehouse", "iceberg", "hudi", "delta", "storage", "manifest", "partition", "snapshot", "z-ordering", "compaction", "zero-etl", "catalog", "nessie", "wap", "deletes", "puffin", "flink", "superset", "kudu", "orc", "avro", "minio", "xtable", "metastore", "amundsen", "datahub", "collibra", "alation", "openlineage"],
        "mechanics": [
    ...
    "Agentic & AI": {
        "keywords": ["agentic", "ai", "llm", "context", "search", "rag", "generative", "prompt", "learning", "reasoning", "orchestration", "tool", "react", "thought", "caching", "window", "chroma", "weaviate", "pinecone", "qdrant", "milvus", "dspy", "llamaindex", "langchain"],
        "mechanics": [
    ...
    "Data Engineering & Query": {
        "keywords": ["etl", "elt", "pipeline", "dag", "schema", "cdc", "query", "sql", "vectorized", "arrow", "parquet", "pushdown", "dbt", "batch", "product", "analytics", "dimension", "datafusion", "paimon", "fluss", "vortex", "lance", "airflow", "dagster", "prefect", "mage", "soda", "fivetran", "airbyte", "debezium", "spark", "trino", "presto", "snowflake", "bigquery", "clickhouse", "duckdb", "medallion", "bronze", "silver", "gold", "lambda", "kappa", "scd", "kafka", "pulsar", "redpanda", "confluent", "materialized"],
        "mechanics": [
