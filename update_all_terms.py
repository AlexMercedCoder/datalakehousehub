...
matrix = {
    ...
    "Lakehouse & Storage": {
        "keywords": ["lakehouse", "iceberg", "hudi", "delta", "storage", "manifest", "partition", "snapshot", "z-ordering", "compaction", "zero-etl", "catalog", "nessie", "wap", "deletes", "puffin", "flink", "superset", "kudu", "orc", "avro", "minio", "metastore", "amundsen", "datahub", "collibra", "alation", "openlineage"],
        "mechanics": [
